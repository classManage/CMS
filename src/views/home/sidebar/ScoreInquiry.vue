   ...
   :header-cell-style="{'text-align':'center'}"
      ...
      <template slot="header">
        ...
        <span>
          ...
          <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item v-for="item in kc"
                      :key="item.id" :command="item.kcname">
                      {{item.kcname}}
                    </el-dropdown-item>
                  </el-dropdown-menu>
        </el-dropdown>
    ...
    <el-table-column
      ...
      <template slot="header">
        ...
        <span>
          ...
          <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item v-for="item in kc"
                      :key="item.id" :command="item.stage">
                      {{item.stage}}
                    </el-dropdown-item>
                  </el-dropdown-menu>
        </el-dropdown>
    ...
    <el-form :inline="true" :model="scoreEdit">
        <el-form-item label="学号">
          <el-input v-model="scoreEdit.stuid" placeholder="学号" size="medium"></el-input>
        </el-form-item>
        <el-form-item label="姓名">
          <el-input v-model="scoreEdit.name" placeholder="姓名" size="medium"></el-input>
       </el-form-item>
